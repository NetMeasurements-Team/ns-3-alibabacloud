...
class MellanoxDcqcn : public RdmaCongestionOps
{
  public:
    ...
    virtual void HandleAck(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader& ch) override;
...
class Hpcc : public RdmaCongestionOps
{
  public:
    ...
    virtual void UpdateRate(Ptr<RdmaQueuePair> qp,
                            Ptr<Packet> p,
                            CustomHeader& ch,
                            bool fast_react);
    virtual void FastReact(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader& ch);
...
class Timely : public RdmaCongestionOps
{
  public:
    ...
    virtual void UpdateRate(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader& ch, bool us);
    virtual void FastReact(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader& ch);
