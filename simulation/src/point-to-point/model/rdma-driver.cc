...
void
RdmaDriver::SetNode(Ptr<Node> node)
{
    m_node = node;
}

void
RdmaDriver::SetRdmaHw(Ptr<RdmaHw> rdma)
{
    m_rdma = rdma;
}
...
void
RdmaDriver::FinishQueuePair(Ptr<RdmaQueuePair> q)
{
    m_rdma->QpComplete(q);
}

void
RdmaDriver::EnbaleNVLS()
{
    m_rdma->enable_nvls();
}

void
RdmaDriver::DisableNVLS()
{
    m_rdma->disable_nvls();
}

void
RdmaDriver::QpComplete(Ptr<RdmaQueuePair> q)
{
    m_traceQpComplete(q);
}
